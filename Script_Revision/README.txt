...
###     le dossier est constitué du script principal en .rename à renommer en .PS1
###     Un fichier CSV cita.csv pour une fonction spéciale à agrémenter celon votre bon plaisir
###     Un sous dossier contenant les fichiers CSV des questionnaires, libre à vous de les modifier, en ajouter, ...
###
...
###
###	Il est possible qu'une erreur est lieue lors de l'import du fichier via la popup windows, c'est lié à la version PS
